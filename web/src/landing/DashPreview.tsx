  ...
  return (
    <section data-scene="quiet" style={{ position: 'relative', padding: '12vh clamp(20px, 4.4vw, 72px) 14vh' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '22px', textAlign: 'center' }}>
        ...
        <button className="hv-violet" onClick={() => go('/app/dash')} style={{ background: '#8052FF', border: 'none', cursor: 'pointer', color: '#FFFFFF', fontSize: '15px', fontWeight: 500, padding: '13px 24px', borderRadius: '8px', marginTop: '6px' }}>Open Lacuna</button>
      </div>
    </section>
  );
}
