...
| Official LongMemEval oracle adapter | The published 500-instance oracle was loaded and adapted on 2026-08-22: 0 parse failures, 0 adapter failures, 0 ground-truth leaks, 128 extracted claims across 84/500 instances (16.8%), with coverage broken down by all six official question types in the artifact. This is ingestion evidence only; no official answer/judge score is claimed. |
