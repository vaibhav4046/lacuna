...
pass; the current candidate full unit suite is 2,242/2,242 (113 files), and the stable alias passed demo
...
suite is 2,242/2,242 (113 files), including the serverless request-lifecycle
...
in the 2,242-test candidate suite and is not described as live until promotion
succeeds.
...
leaving a query waiting forever. Its regression is covered in the 2,242-test
candidate suite.
...
and is included in the 2,242-test candidate suite.
