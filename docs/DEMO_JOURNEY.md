...
Every value on this page was re-run against a live node on 2026-08-15 with the
...
In the session "Trust incident follow-up", among 5,268 messages across 72
sessions, one message states:

> "We were asked for an update on Bellwether. The beta partner for Bellwether
> is Stonecrop."

That becomes claim `#2475749815969757`, valid from 2025-03-03. Around it the
corpus does what real chat history does: "Stonecrop" appears in 48 messages,
and 36 of them state nothing at all ("Nothing new on Stonecrop this week", "We
skipped Stonecrop today"). Any retriever that ranks by mention frequency
drowns here. That is deliberate.
...
> — "Data handover notes", 2025-03-07

> "Correction on Bellwether: the beta partner is now Halverd."
> — "Platform handover notes", 2025-03-11
...
#2475749815969757  2025-03-03    Stonecrop  superseded by #2247326196671333
#2247326196671333  2025-03-07    Millbrace  superseded by #797564529472318
#797564529472318   2025-03-11    Halverd    current, answered with this
```
...
> "replay-queue is supplied by Northfold." — "Platform planning call", 2025-03-21

> "Our contact at Northfold is Farah Haddad." — "Data handover notes", 2025-03-23
...
it by sweeping all sixty gold questions through the three surfaces and
comparing field by field; the saved run ends `SWEEP_IDENTICAL: 60 of 60` and
`ALL_IDENTICAL: True`
...
other 57 gold questions cover these plus the remaining kinds (stable,
retracted, contradicted, unconnected, out_of_scope); `npm run eval` runs all
sixty and the committed benchmark scores them 60/60 with zero false answers. These three
