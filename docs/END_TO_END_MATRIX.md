...
| Unit tests | The suite that needs no database | `npx vitest run tests/unit` | 1,202 passed, 59 files | [RELEASE_GATE.md](../RELEASE_GATE.md), recorded in [artifacts/verification/2026-08-19/unit.txt](../artifacts/verification/2026-08-19/unit.txt). Earlier dated artifacts keep their own counts and are not edited |
