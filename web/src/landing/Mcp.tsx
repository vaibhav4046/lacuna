  ...
  return (
    <section id="mcp" data-scene="mcp" style={{ position: 'relative', height: '145vh' }}>
      <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', bottom: '12%', left: 0, right: 0, textAlign: 'center', fontFamily: MONO, fontSize: '11.5px', letterSpacing: '0.14em', color: '#7A7A7A' }}>query · remember · explain · timeline · evidence · context pack · health · handoff</div>
      </div>
    </section>
  );
}
