...
| focused connector, auth, voice, agent and onboarding gates | focused connector/auth/voice/agent regressions plus onboarding readiness coverage passed; current candidate full unit suite is 2,287/2,287 | serial terminal runs on 2026-08-22 with one worker |
