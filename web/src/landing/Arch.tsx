  ...
  return (
    <section id="how" data-scene="arch" style={{ position: 'relative', height: '300vh' }}>
      <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden' }}>
        ...
        <div data-mhide="1" style={{ position: 'absolute', left: 'clamp(16px, 3.4vw, 56px)', top: 'max(56%, min(480px, calc(100vh - 200px)))', display: 'flex', flexDirection: 'column', gap: '9px', fontFamily: MONO, fontSize: '9.5px', letterSpacing: '0.16em', color: '#71717A' }}>
        ...
        <div data-mhide="1" style={{ position: 'absolute', bottom: '6%', left: 0, right: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '11px', padding: '0 24px' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '8px 20px', fontFamily: MONO, fontSize: '10px', letterSpacing: '0.2em', color: '#71717A' }}>
          ...
          <span style={{ fontFamily: MONO, fontSize: '10px', letterSpacing: '0.2em', color: '#5E5E5E' }}>HYDRADB · PERSISTENT GRAPH STATE · MEMORY · KNOWLEDGE · RELATIONSHIPS · HISTORY</span>
        </div>
      </div>
    </section>
  );
