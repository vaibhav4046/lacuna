...
export function Final() {
  ...
  return (
    <section data-scene="final" style={{ position: 'relative', height: '210vh' }}>
      <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: 'max(11%, 96px)', left: 0, right: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px', textAlign: 'center', padding: '0 20px' }}>
