...
| --- | --- | --- |
| focused connector, auth, voice and agent gates | 329 focused connector tests plus private-mutation/auth/voice/agent regressions passed; current candidate full unit suite 2,247/2,247 (114 files) | serial terminal runs on 2026-08-22 with one worker |
