...
| Unit tests | The suite that needs no database | `npx vitest run tests/unit` | 1033 passed, 52 files | [RELEASE_GATE.md](../RELEASE_GATE.md). The committed artifact [unit.txt](../artifacts/verification/2026-08-18-gates/unit.txt) records the earlier count of 921 over 41 files and is kept unedited |
