...
| --- | --- | --- |
| focused connector, auth, voice and agent gates | 166 structured connector tests plus private-mutation/auth/voice/agent regressions passed; full unit suite 2,225/2,225 (111 files) | serial terminal runs on 2026-08-22 with one worker |
