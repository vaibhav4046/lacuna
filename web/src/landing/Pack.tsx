  ...
  return (
    <section data-scene="pack" style={{ position: 'relative', height: '220vh' }}>
      <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden' }}>
        ...
        <div data-fx="pack-l" className="pack-list" data-shield style={{ position: 'absolute', left: 'min(66%, calc(100vw - 300px))', top: '46%', opacity: 0, display: 'flex', flexDirection: 'column', gap: '9px', fontFamily: MONO, fontSize: '12px', letterSpacing: '0.16em', color: '#D0D0D6' }}>
          <span>FACTS</span>
